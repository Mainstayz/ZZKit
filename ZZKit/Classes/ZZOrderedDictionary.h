 ...
 */
@interface ZZOrderedDictionary<__covariant KeyType, __covariant ObjectType> : NSDictionary<KeyType, ObjectType>
 ...
 */
@interface MutableOrderedDictionary<KeyType, ObjectType> : ZZOrderedDictionary<KeyType, ObjectType>
