...
@property (nonatomic, readonly) ZZOrderedDictionary *root;

- (instancetype)initWithData:(NSData *)data  root:(ZZOrderedDictionary *)root;

@end


@implementation ZZOrderedDictionary
{
    @protected
    NSArray *_values;
    NSOrderedSet *_keys;
...
- (instancetype)init
{
    if ((self = [super init]) && [self class] == [ZZOrderedDictionary class])
    {
        static ZZOrderedDictionary *singleton;
...
{
    return [[ZZOrderedDictionary allocWithZone:zone] initWithDictionary:self];
}
