...
@class NBS_PBS_GCDAsyncReadPacket, NBS_PBS_GCDAsyncSocketPreBuffer, NBS_PBS_GCDAsyncWritePacket, NSData, NSMutableArray, NSString, NSURL;
@protocol NBS_PBS_GCDAsyncSocketDelegate, OS_dispatch_queue, OS_dispatch_source;

@interface NBS_PBS_GCDAsyncSocket : NSObject
{
    unsigned int flags;
    unsigned short config;
    id <NBS_PBS_GCDAsyncSocketDelegate> delegate;
    ...
    NBS_PBS_GCDAsyncReadPacket *currentRead;
    NBS_PBS_GCDAsyncWritePacket *currentWrite;
    unsigned long long socketFDBytesAvailable;
    NBS_PBS_GCDAsyncSocketPreBuffer *preBuffer;
    struct {
        long long version;
        void *info;
    ...
    NBS_PBS_GCDAsyncSocketPreBuffer *sslPreBuffer;
...
@property __weak id <NBS_PBS_GCDAsyncSocketDelegate> delegate;
