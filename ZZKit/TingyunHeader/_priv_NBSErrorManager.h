...
- (void)logErrorWithHTTPError:(id)arg1 Response:(id)arg2 ResponseData:(id)arg3 withIP:(id)arg4 cdnAssosiateInfo:(id)arg5 libClass:(long long)arg6 appPhase:(long long)arg7;
- (void)logErrorWithError:(id)arg1 Request:(id)arg2 withIP:(id)arg3 cdnAssosiateInfo:(id)arg4 libClass:(long long)arg5 appPhase:(long long)arg6;
...
- (id)getKeyFromURI:(id)arg1 urlParams:(id)arg2 statusCode:(int)arg3 httpMethod:(id)arg4 libClass:(long long)arg5 appPhase:(long long)arg6;
- (void)dealloc;
- (id)init;
